...
var bulmaQuickview = function (_EventEmitter) {
  ...
  _createClass(bulmaQuickview, [{
    ...
    value: function value(e) {
        if (isValidURL(document.querySelector("#largeUrlField").value)) {
        document.querySelector("#largeUrlField").disabled = true;

        this.quickview.classList.toggle('is-active');
        if (this.quickview.classList.contains('is-active')) {
          e.target.innerHTML = '<div class="loader"></div>'
        } else {
          document.querySelector("#largeUrlField").disabled = false;
          e.target.innerText = 'Acortar';
        }
    ...
    value: function value(e) {
      ...
      document.querySelector("#generateLinkForm > div > div:nth-child(2) > button").innerHTML = '';
      document.querySelector("#generateLinkForm > div > div:nth-child(2) > button").innerHTML = 'Acortar';
      document.querySelector("#largeUrlField").disabled = false;
